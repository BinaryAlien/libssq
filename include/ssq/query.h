 ...
 * @return a dynamically-allocated buffer containing the server's query response
 */
char *ssq_query(SSQ_QUERIER *querier, const char *payload, size_t payload_len, size_t *response_len);
